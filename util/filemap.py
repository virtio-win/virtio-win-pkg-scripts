...
FILELISTS = {}
_balloonfiles = ['balloon.cat', 'balloon.inf', 'balloon.pdb', 'balloon.sys',
    'blnsvr.exe', 'blnsvr.pdb']
...
FILELISTS['NetKVM:xp'] = ['netkvm.cat', 'netkvm.inf', 'netkvm.pdb',
    'netkvm.sys']
FILELISTS['NetKVM:2k3'] = FILELISTS['NetKVM:xp']
FILELISTS['NetKVM'] = FILELISTS['NetKVM:xp'][:] + ["netkvmco.dll",
    "readme.doc"]

FILELISTS['qxl'] = ["qxl.cat", "qxldd.dll", "qxl.inf", "qxl.sys"]

_viorngfiles = ['viorng.cat', 'viorngci.dll', 'viorng.inf', 'viorng.pdb',
    'viorngum.dll', 'viorng.sys']
...
FILELISTS['vioscsi'] = ['vioscsi.sys', 'vioscsi.cat', 'vioscsi.inf',
    'vioscsi.pdb']

_vioserialfiles = ['vioser.sys', 'vioser.cat', 'vioser.inf', 'vioser.pdb']
...
FILELISTS['viostor'] = ['viostor.sys', 'viostor.cat', 'viostor.inf',
    'viostor.pdb']
